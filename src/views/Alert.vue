<template>
  <div class="flex flex-col items-start p-1" dir="ltr">
    ...
    <div class="flex flex-col items-start mt-10 border rounded-sm p-3 w-full shadow-md">
      ...
      <iframe width="100%" height="300" src="//jsfiddle.net/mohstarsos1/s2xt5p0d/4/embedded/html/dark/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
    </div>
    ...
    <div class="flex flex-col items-start mt-10 border rounded-sm p-3 w-full shadow-md">
      ...
      <iframe width="100%" height="300" src="//jsfiddle.net/mohstarsos1/71tvkgsp/2/embedded/html/dark/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
    </div>

    <div class="flex flex-col items-start mt-10 border rounded-sm p-3 w-full shadow-md">
      <h2 class="text-xl font-bold mb-2">Icon and Closeable</h2>
      <p class="mb-2">Choose this alert, with icon and close button to disapear.</p>
      ...
      <t-alert v-model="showAlert2" icon="home" variant="success" class="w-full">
        This is a closeable with icon alert message...
      </t-alert>
      <iframe width="100%" height="300" src="//jsfiddle.net/mohstarsos1/d1h07mkp/4/embedded/html,js/dark/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
    </div>
...
export default defineComponent({
  ...
  async mounted() {
    this.mdFile = await fetch("/tailwind/alert/README.md").then((res) => res.text());
  },
});
</script>
