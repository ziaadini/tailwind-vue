...
export default defineComponent({
  ...
  props: {
    ...
    rounded: {
      type: Boolean,
      default: () => inject("t-bottom-sheet-rounded", true)
    },
    title: {
      type: String,
      default: ""
    ...
    titleTag: {
      type: String,
      default: () => inject("t-bottom-sheet-titleTag", "h4")
    },
    teleportTo: {
      type: String,
      default: () => inject("t-bottom-sheet-teleportTo", undefined)
    },
    hasCloseButton: {
      type: Boolean,
      default: () => inject("t-bottom-sheet-hasCloseButton", true)
    },
    maxSize: {
      type: String,
      default: () => inject("t-bottom-sheet-maxSize", "md"),
    ...
    full: {
      type: Boolean,
      default: () => inject("t-bottom-sheet-full", false)
    },
    eager: {
      type: Boolean,
      default: () => inject("t-bottom-sheet-eager", false)
    },
    backDrop: {
      type: Boolean,
      default: () => inject("t-bottom-sheet-backDrop", true)
    }
  },
